...
class RiesgoCalculator {
    static procesarEstadisticas(datos) {
        ...
        const tiempoRespuestaPromedio = totalIncidentes > 0
            ? Math.round(sumaTiempoRespuesta / totalIncidentes)
            : 0;
        medianas.sort((a, b) => a - b);
        const tiempoRespuestaMediana = medianas.length > 0 ? medianas[Math.floor(medianas.length / 2)] : 0;
...
exports.RiesgoCalculator = RiesgoCalculator;
//# sourceMappingURL=riesgo.calculator.js.map