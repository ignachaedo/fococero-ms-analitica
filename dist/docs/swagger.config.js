...
exports.swaggerDocument = {
    ...
    info: {
        ...
        version: "1.0.0",
        description: "API de alta disponibilidad para el análisis de incidentes, predicción de riesgos y procesamiento geoespacial.",
        contact: {
    ...
    paths: {
        ...
        "/core/kpis": {
            get: {
                ...
                description: "Calcula total de incidentes, promedios de respuesta y nivel de riesgo global.",
        ...
        "/core/anomalias": {
            get: {
                ...
                description: "Identifica picos estadísticos inusuales en el comportamiento de los incidentes.",
        ...
        "/espacial/heatmap": {
            get: {
                ...
                description: "Retorna una FeatureCollection para renderizar mapas de calor.",
        ...
        "/espacial/radio": {
            get: {
                ...
                description: "Busca incidentes dentro de un radio en metros desde un punto lat/lng.",
        ...
        "/predictiva/pronostico": {
            get: {
                ...
                description: "Predice la carga de incidentes para la próxima semana usando medias móviles.",
        ...
        "/cache/limpiar": {
            delete: {
                ...
                description: "Elimina todas las entradas de analítica en el caché distribuido.",
